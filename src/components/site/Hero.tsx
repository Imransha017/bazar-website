...
// Fallbacks only render when no banners exist in the database. They link to
// /categories (a route that always resolves) instead of guessed category slugs.
const fallbackSlides: Banner[] = [
  { id: "f1", placement: "hero_slider", title: "Mobile Mega Offer", subtitle: "", image_url: hero1, link_url: "/categories", gradient_from: "", gradient_to: "" },
  { id: "f2", placement: "hero_slider", title: "Fashion Bonanza", subtitle: "", image_url: hero2, link_url: "/categories", gradient_from: "", gradient_to: "" },
  { id: "f3", placement: "hero_slider", title: "Home Essentials", subtitle: "", image_url: hero3, link_url: "/categories", gradient_from: "", gradient_to: "" },
];

const fallbackSide: Banner[] = [
  { id: "fs1", placement: "hero_side", title: "Audio Fest", subtitle: "From ৳499", image_url: "", link_url: "/categories", gradient_from: "from-violet-500", gradient_to: "to-fuchsia-600" },
  { id: "fs2", placement: "hero_side", title: "Beauty Week", subtitle: "Up to 60% OFF", image_url: "", link_url: "/categories", gradient_from: "from-rose-400", gradient_to: "to-pink-600" },
];
...
function uniqueBanners(items: Banner[]) {
  ...
  return items.filter((banner) => {
    const signature = [
      ...
      banner.subtitle.trim().toLowerCase(),
...
export function Hero() {
  ...
  useEffect(() => {
    (async () => {
      ...
      const sl = uniqueBanners(data.filter((b: Banner) => b.placement === "hero_slider"));
      const sd = uniqueBanners(data.filter((b: Banner) => b.placement === "hero_side")).slice(0, 2);
  ...
  return (
    <section className="mx-auto max-w-none pt-3 md:pt-4">
      {settings.homepage.hero_video_url && (
        <div className="mb-3 overflow-hidden rounded-md shadow-card aspect-video max-h-[400px]">
          <video 
            src={settings.homepage.hero_video_url} 
            autoPlay 
            muted 
            loop 
