        ...
        <div className="mx-auto max-w-lg p-6">
          <div className="rounded-2xl border-2 border-primary/30 bg-gradient-to-br from-primary/5 via-card to-amber-50 p-8 text-center shadow-lg">
            ...
            <div className="mt-6 flex flex-col gap-2 sm:flex-row sm:justify-center">
              ...
              <Link to="/auth" search={{ redirect: "/become-vendor", mode: "login" }} className="rounded border px-6 py-2 text-sm font-bold">Go to Login</Link>
            </div>
          </div>
        </div>
      </SiteLayout>
        ...
        <div className="mb-4 rounded-2xl bg-gradient-brand p-5 text-brand-foreground shadow-lg md:p-6">
          ...
          {!user && (
            <div className="mt-3 rounded-lg bg-white/15 p-2.5 text-[11px] backdrop-blur">
              Already have an account? <Link to="/auth" search={{ redirect: "/become-vendor", mode: "login" }} className="font-bold underline">Sign in</Link> to continue your application.
            </div>
          )}
        </div>
