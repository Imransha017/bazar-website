      ...
      <SiteLayout>
        <div className="mx-auto max-w-md px-4 py-16 text-center">
          <div className="rounded-lg border bg-card p-6 shadow-card">
            ...
            <Link to="/auth" search={{ redirect: "/", mode: "login" }} className="mt-5 inline-block text-sm font-semibold text-primary hover:underline">
              ← Back to Login
            </Link>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-lg px-4 py-10">
          <div className="rounded-lg border bg-card p-6 shadow-card">
            ...
            <div className="mt-5 flex items-center justify-between text-xs">
              <Link to="/auth" search={{ redirect: "/", mode: "login" }} className="font-semibold text-primary hover:underline">← Back to Login</Link>
              <button
                type="button"
    ...
    <SiteLayout>
      <div className="min-h-[calc(100vh-200px)] bg-gradient-to-b from-sky-50 to-background">
        <div className="mx-auto max-w-md px-4 py-6 md:py-12">
          <Link to="/auth" search={{ redirect: "/", mode: "login" }} className="mb-3 inline-flex items-center gap-1 text-xs text-muted-foreground hover:text-foreground">
