    ...
    return (
      <SiteLayout>
        <div className="mx-auto max-w-lg p-8 text-center">
          ...
          <Link to="/auth" search={{ redirect: "/affiliate", mode: "login" }} className="mt-4 inline-block rounded bg-primary px-6 py-2 text-sm font-bold text-primary-foreground">Sign in to apply</Link>
        </div>
      </SiteLayout>
    );
  }
